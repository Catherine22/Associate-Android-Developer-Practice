        ...
        if (listener != null) {
            mainRvHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    listener.onItemClick(mainRvHolder.itemView, position);
                }
            });
...
//            mainRvHolder.sdv_main.setImageURI(uri);
        ...
        if (!TextUtils.isEmpty(cardItem.getLButton())) {
            ...
            if (lBListener != null) {
                mainRvHolder.bt_left.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        lBListener.onItemClick(mainRvHolder.itemView, position);
                    }
                });
                mainRvHolder.bt_left.setOnLongClickListener(new View.OnLongClickListener() {
                    @Override
                    public boolean onLongClick(View v) {
        ...
        if (!TextUtils.isEmpty(cardItem.getRButton())) {
            ...
            if (rBListener != null) {
                mainRvHolder.bt_right.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        rBListener.onItemClick(mainRvHolder.itemView, position);
                    }
                });
                mainRvHolder.bt_right.setOnLongClickListener(new View.OnLongClickListener() {
                    @Override
                    public boolean onLongClick(View v) {
